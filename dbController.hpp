...
public:
    ...
    void matchOrders(pqxx::work &txn, int accountID, int newTransID, const string &symbol, float amt, float limit);
    void updateBuyerPosition(pqxx::work &txn, int accountID, const string &symbol, float amt);
    void updateSellerAccount(pqxx::work &txn, int accountID, float amount);
